...
public class OverloadLimitFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_max_power, container, false);
        ...
        channelTitle.setText("Load Limit Channel-"+currentChannel);
    ...
    private void readBalance(String data) {
        ...
        currBal.setText("Current Load Limit :"+currentBalance+" Wh");
    }
    ...
    public void onClick(View view) {
        ...
        switch (currentChannel) {
            case 1:
                channelBalanceId = 1;
                send(ChannelConstants.OVERLOAD_LIMIT);
    ...
    private void setChannelHexa() {
        switch (currentChannel) {
            case 1:
                ...
                channelhexa = "64 06 00 74";
                break;
            case 2:
                //channelBalanceId = 2;
                //send(ChannelConstants.CHANNEL_BALANCE);
                channelhexa = "64 06 00 75";
                break;
            case 3:
                //channelBalanceId = 3;
                //send(ChannelConstants.CHANNEL_BALANCE);
                channelhexa = "64 06 00 76";
                break;
            case 4:
                //channelBalanceId = 4;
                //send(ChannelConstants.CHANNEL_BALANCE);
                channelhexa = "64 06 00 77";
                break;
            case 5:
                //channelBalanceId = 5;
                //send(ChannelConstants.CHANNEL_BALANCE);
                channelhexa = "64 06 00 78";
                break;
            case R.id.cancel_recharge:
                toggleChannelList();
                break;
