...
public class AllowedWhFragment extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_allowed_wh, container, false);
        ...
        channelTitle.setText("Allowed WH Channel-"+currentChannel);
    ...
    private void readBalance(String data) {
        ...
        currBal.setText("Current Allowed WH :"+currentBalance+" Wh");
    }
    ...
    public void onClick(View view) {
        ...
        switch (currentChannel) {
            case 1:
                channelBalanceId = 1;
                send(ChannelConstants.ALLOWED_WH);
