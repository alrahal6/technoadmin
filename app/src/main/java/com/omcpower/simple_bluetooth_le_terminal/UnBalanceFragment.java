...
public class UnBalanceFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_un_balance, container, false);

        final EditText userInput = view.findViewById(R.id.recharge_amount);
        //userInput.setText("5");
        userInput.setFilters(new InputFilter[]{new InputFilterMinMax("1", "255")});
    ...
    private void readBalance(String data) {
        ...
        currBal.setText("Current Unbalance :" + Integer.parseInt(withoutWhite.substring(6, 10), 16));
    }
