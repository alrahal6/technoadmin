...
public class BalanceYearFragment extends BaseFragment
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_balance_year, container, false);
        ...
        tvDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                pd.setListener(BalanceYearFragment.this);
    ...
    private void readBalance(String data) {
        ...
        currBal.setText("Year Channel-"+channelBalanceId+" :"+currentBalance);
    }
    ...
    public void onClick(View view) {
        ...
        switch (currentChannel) {
            case 1:
                channelBalanceId = 1;
                send(ChannelConstants.CHANNEL_ONE_YEAR);
                channelhexa = "64 06 00 68";
                break;
            case 2:
                channelBalanceId = 2;
                send(ChannelConstants.CHANNEL_TWO_YEAR);
                channelhexa = "64 06 00 69";
                break;
            case 3:
                channelBalanceId = 3;
                send(ChannelConstants.CHANNEL_THREE_YEAR);
                channelhexa = "64 06 00 6A";
                break;
            case 4:
                channelBalanceId = 4;
                send(ChannelConstants.CHANNEL_FOUR_YEAR);
                channelhexa = "64 06 00 6B";
                break;
            case 5:
                channelBalanceId = 5;
                send(ChannelConstants.CHANNEL_FIVE_YEAR);
    ...
    private void setChannelHexa() {
        switch (currentChannel) {
            case 1:
                //channelBalanceId = 1;
                //send(ChannelConstants.CHANNEL_BALANCE);
                channelhexa = "64 06 00 86";
                break;
            case 2:
                //channelBalanceId = 2;
                //send(ChannelConstants.CHANNEL_BALANCE);
                channelhexa = "64 06 00 88";
                break;
            case 3:
                //channelBalanceId = 3;
                //send(ChannelConstants.CHANNEL_BALANCE);
                channelhexa = "64 06 00 8A";
                break;
            case 4:
                //channelBalanceId = 4;
                //send(ChannelConstants.CHANNEL_BALANCE);
                channelhexa = "64 06 00 8C";
                break;
            case 5:
                //channelBalanceId = 5;
                //send(ChannelConstants.CHANNEL_BALANCE);
                channelhexa = "64 06 00 8E";
                break;
            case R.id.cancel_recharge:
                toggleChannelList();
                break;
